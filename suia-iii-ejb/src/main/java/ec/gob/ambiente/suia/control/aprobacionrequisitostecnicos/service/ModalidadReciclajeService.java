...
/**
 * <b> Clase que contiene los servicios para modalidad reciclaje. </b>
 * 
 * @author vero
 ...
 */
@Stateless
public class ModalidadReciclajeService {
	@EJB
	...
	public ModalidadReciclaje getModalidadReciclaje(AprobacionRequisitosTecnicos aprobacion) throws ServiceException {
		List<ModalidadReciclaje> lista = null;
		try {
			lista = crudServiceBean.getEntityManager()
					.createQuery("From ModalidadReciclaje m where m.aprobacionRequisitosTecnicos =:aprobacion")
