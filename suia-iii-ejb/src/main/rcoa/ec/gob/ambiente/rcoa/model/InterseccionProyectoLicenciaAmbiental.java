...
@Entity
@Table(name = "intersections_project_licencing_coa", schema = "coa_mae")
@AttributeOverrides({
...
public class InterseccionProyectoLicenciaAmbiental extends EntidadAuditable implements Serializable {
