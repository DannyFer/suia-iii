...
@Entity
@Table(name = "project_licencing_coa_shapes", schema = "coa_simulator")
@AttributeOverrides({
...
public class SimuladorProyectoLicenciaAmbientalCoaShape extends EntidadAuditable {
	...
	public boolean esAreaImplantacion() {
		if(tipo==1)
			return true;
		return false;
	} 
