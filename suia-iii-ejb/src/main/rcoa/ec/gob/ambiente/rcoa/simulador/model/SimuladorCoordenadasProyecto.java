...
@Entity
@Table(name = "coordinates_project_licencing_coa", schema = "coa_simulator")
@AttributeOverrides({
...
public class SimuladorCoordenadasProyecto extends EntidadAuditable {
	...
	@Getter
	@Setter
	private SimuladorProyectoLicenciaAmbientalCoaShape proyectoLicenciaAmbientalCoaShape;
