...
@Entity
@Table(name = "project_licencing_coa", schema = "coa_mae")
@AttributeOverrides({
...
@NamedQueries({ 
@NamedQuery(name=ProyectoLicenciaCoa.GET_PROYECTO_SIN_FILTRO, query="SELECT p FROM ProyectoLicenciaCoa p where p.id=:idProyecto")
 })

@Filter(name = EntidadBase.FILTER_ACTIVE, condition = "prco_status = 'TRUE'")
public class ProyectoLicenciaCoa extends EntidadAuditable {
	...
	public static final String GET_PROYECTO_SIN_FILTRO = PAQUETE + "ProyectoLicenciaCoa.getProyectoSinFiltro";
	...
	@Getter
	@Setter
	@Column(name = "prco_ramsar_intersection")
	...
	@Getter
	@Setter
	@Column(name = "prco_intersection_update_status")
	private Integer estadoActualizacionCertInterseccion = 0;
	
	@Getter
	@Setter
	@Column(name = "prco_status_assigned_area")
	private Integer estadoAsignacionArea = 1;
	
	@Getter
	@Setter
	@Column(name = "prco_environmental_regulations")
	private Boolean diagnosticoCumpleNormativa;
	...
	@Getter
	@Setter
	@Column(name = "prco_rsq_process_start")
	private Boolean iniciaProcesoRsq;
	
	@Getter
	@Setter
	@Column(name = "prco_have_document_rsq")
	private Integer tieneDocumentoRsq;
	
	@Getter
	@Setter
	@Column(name = "prco_shrimp_concession")
	private String concesionCamaronera;
	
	@Getter
	@Setter
	@OneToOne(mappedBy = "proyectoLicenciaCoa")
