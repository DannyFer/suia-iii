...
@ManagedBean
@ViewScoped
public class DirectorRevisarInformeOficioObservacionesICAController extends OficioObservacionICAController {

	private static final long serialVersionUID = -6046751864795495689L;

	private final Logger LOG = Logger.getLogger(DirectorRevisarInformeOficioObservacionesICAController.class);
	...
	public void validarTareaBpm() {
		JsfUtil.validarPaginasUrlTareasBpm(JsfUtil.getCurrentTask(),
				"/control/inspeccionescontrolambiental/directorRevisarInformeOficioObservaciones.jsf");
	}
}
