...
@ManagedBean
@ViewScoped
public class CoordinadorRevisarInformeOficioObservacionesICAController extends OficioObservacionICAController {

	private static final long serialVersionUID = 113792596572178829L;

	private final Logger LOG = Logger.getLogger(CoordinadorRevisarInformeOficioObservacionesICAController.class);
	...
	public void validarTareaBpm() {
		JsfUtil.validarPaginasUrlTareasBpm(JsfUtil.getCurrentTask(),
				"/control/inspeccionescontrolambiental/coordinadorRevisarInformeOficioObservaciones.jsf");
	}
}
