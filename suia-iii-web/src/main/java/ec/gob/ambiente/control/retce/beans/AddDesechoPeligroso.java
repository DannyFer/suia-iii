...
@ManagedBean
@ViewScoped
public class AddDesechoPeligroso implements Serializable {
			...
			if (getFilter().trim().isEmpty()) {
				...
				if (categorias != null) {
					...
					for (CategoriaFuenteDesechoPeligroso categoria : categorias) {
						...
						} else if(categoria.getCodigo().equals(CategoriaFuenteDesechoPeligroso.CODIGO_NO_ESPECIFICA)){
				...
				List<DesechoPeligroso> desechos = desechoPeligrosoFacade
						.buscarDesechosPeligrosoPorFuentePorDescripcion(getFilter());
