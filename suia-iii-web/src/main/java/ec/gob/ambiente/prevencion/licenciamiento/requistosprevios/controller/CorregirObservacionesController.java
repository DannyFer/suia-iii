...
import ec.gob.ambiente.prevencion.licenciamiento.requistosprevios.bean.CorregirObservacionesBean;
 ...
 */
@ManagedBean
public class CorregirObservacionesController {

	private static final Logger LOGGER = Logger.getLogger(CorregirObservacionesController.class);

	@EJB
	private ProcesoFacade procesoFacade;

	@Setter
	@ManagedProperty(value = "#{corregirObservacionesBean}")
	private CorregirObservacionesBean corregirObservacionesBean;
