...
import ec.gob.ambiente.prevencion.viabilidadtecnica.bean.ObservacionesViabilidadTecnicaBean;
...
@RequestScoped
@ManagedBean
public class ObservacionesViabilidadTecnicaController implements Serializable {
	...
	@Getter
	@Setter
	@ManagedProperty(value = "#{observacionesViabilidadTecnicaBean}")
	private ObservacionesViabilidadTecnicaBean observaciones;

	@Getter
	@Setter
	private Map<String, ObservacionesViabilidadTecnicaBean> listaObservacionesBB;
	...
	public String obtenerIdSeccion(String idFormulario) {
		ObservacionesViabilidadTecnicaBean observacion = listaObservacionesBB.get(idFormulario);
		String sec = "";
	...
	public void cargarObservaciones(String idFormulario, String nombreClase,
		...
		try {
			ObservacionesViabilidadTecnicaBean observacion = new ObservacionesViabilidadTecnicaBean();
	 ...
	 * @param seccion
	 */
	public void reasignarIndice(ObservacionesViabilidadTecnicaBean observacionesBB,
			String seccion) {
	...
	public ObservacionesViabilidadTecnicaBean getObservacionesBB() {
		return getObservacionesBB("id");
	}

	public ObservacionesViabilidadTecnicaBean getObservacionesBB(String idFormulario) {
		if (listaObservacionesBB.containsKey(idFormulario)) {
			return listaObservacionesBB.get(idFormulario);
		}
		return new ObservacionesViabilidadTecnicaBean();
	}
