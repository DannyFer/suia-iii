...
import ec.gob.ambiente.prevencion.requisitosprevios.bean.AdjuntarOficioRequisitosTecnicosBean;
...
@RequestScoped
@ManagedBean
public class AdjuntarOficioRequisitosTecnicosController implements Serializable {

    private static final long serialVersionUID = -35903524734524686L;
    private static final Logger LOGGER = Logger
            .getLogger(AdjuntarOficioRequisitosTecnicosController.class);
    @EJB
    ...
    private AdjuntarOficioRequisitosTecnicosBean adjuntarOficioRequisitosTecnicosBean;


    public String realizarTarea() {
        if (adjuntarOficioRequisitosTecnicosBean.isAprobacionFavorable()) {
            if (adjuntarOficioRequisitosTecnicosBean.isSubido()) {
                try {
                    //Subir Oficio
                    licenciaAmbientalFacade.ingresarPronunciamiento(adjuntarOficioRequisitosTecnicosBean.getOficio(),
                            adjuntarOficioRequisitosTecnicosBean.getProyecto().getId(), adjuntarOficioRequisitosTecnicosBean.getProyecto().getCodigo(),
            ...
            JsfUtil.addMessageInfo("Para continuar con el proceso de Licenciamiento Ambiental, debe proceder a presentar los\n" +
                    "requisitos técnicos establecidos en los anexos B y/o C del Acuerdo Ministerial No. 026 deRegistro Oficial No. 334 del 12 de mayo del 2008, según corresponda, para análisis y\n" +
