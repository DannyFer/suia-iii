...
@RequestScoped
@ManagedBean
public class AsignarTecnicoInformeForestalController implements Serializable {

	private static final long serialVersionUID = -352637127226L;
	private static final Logger LOGGER = Logger
			.getLogger(AsignarTecnicoInformeForestalController.class);
	@EJB
	...
	public void delegarTecnico() {
		reasignarTareaComunBean.initFunctionOnNotStatartedTask(
				...
				"Delegar a Técnico para informe forestal.",
				"u_TecnicoForestal", "admin", null,
