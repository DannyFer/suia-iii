...
public class InformeInspeccionForestalCAController implements Serializable {
	...
	public String firmarOficio() {
		try {
			...
			if(!documentoSubido.getUsuarioCreacion().equals(JsfUtil.getLoggedUser().getNombre()) 
					|| !JsfUtil.getSimpleDateFormat(documentoSubido.getFechaCreacion()).equals(JsfUtil.getSimpleDateFormat(new Date()))) {
