...
@RequestScoped
@ManagedBean
public class ReasignarTecnicoJuridicoLAController implements
        Serializable {

    private static final Logger LOGGER = Logger
            .getLogger(ReasignarTecnicoJuridicoLAController.class);
    private static final long serialVersionUID = 5587495467100384471L;
    ...
    public void delegarTecnico() {
        ...
        reasignarTareaComunBean
                .initFunctionOnNotStatartedTask(proces.getExternalId(),
                        ...
                        "Delegar a técnico jurídico para analizar la información.",
                        "u_TecnicoJuridico", Constantes.getRoleAreaName(roleType),
    ...
    public void InicializarDatos() {
        ...
        try {
            ...
            roleType = "role.tecnico.Juridico";
//
...
//            }
            ...
            if(proyecto.getAreaResponsable().getTipoArea().getSiglas().toUpperCase().equals(Constantes.SIGLAS_TIPO_AREA_PC)) {
            	Area areaJuridica = areaFacade.getAreaSiglas("CGAJ") ;
            	subarea = areaJuridica.getAreaName();
            }
    ...
    public void validarTareaBpm() {
        JsfUtil.validarPaginasUrlTareasBpm(bandejaTareasBean.getTarea(), "/prevencion/licenciamiento-ambiental/asignarTecnicoJuridico.jsf");
    }
}
