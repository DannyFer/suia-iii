...
@ManagedBean
@ViewScoped
public class RevisarDocumentosVTBean implements Serializable {

	private static final long serialVersionUID = -4920796353639127645L;

    private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(RevisarDocumentosVTBean.class);
    ...
    @Setter
    @Getter
    private Boolean requiereObservaciones;
    ...
    public void validarTareaBpm() {
        JsfUtil.validarPaginasUrlTareasBpm(bandejaTareasBean.getTarea(), "/prevencion/emisionviabilidadtecnica/revisarDocumentos.jsf");
    }
}
