...
@ViewScoped
@ManagedBean
public class AsignarTecnicoResposableLAController implements
        Serializable {
    ...
    private static final Logger LOGGER = Logger
            .getLogger(AsignarTecnicoResposableLAController.class);
    @EJB
    ...
    public void delegarTecnico() {
        ...
        reasignarTareaComunBean
                .initFunctionOnNotStatartedTask(proces.getExternalId(),
                        ...
                        "Delegar a técnico responsable para analizar la información.",
    ...
    public void validarTareaBpm() {
        ...
        String url = "/prevencion/licenciamiento-ambiental/asignarTecnicoResponsable.jsf";
