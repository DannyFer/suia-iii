...
@ManagedBean
@ViewScoped
public class ObservacionesInspeccionVTBean implements Serializable {

	private static final long serialVersionUID = -4920799635839127645L;

    private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(ObservacionesInspeccionVTBean.class);
    ...
    public void validarTareaBpm() {
        JsfUtil.validarPaginasUrlTareasBpm(bandejaTareasBean.getTarea(), "/prevencion/emisionviabilidadtecnica/observacionesInspeccion.jsf");
    }
}
