...
@RequestScoped
@ManagedBean
public class RealizarInformeForestalController implements Serializable {
	private static final long serialVersionUID = -352637373736666L;

	private static final Logger LOGGER = Logger
			.getLogger(RealizarInformeForestalController.class);
	@EJB
