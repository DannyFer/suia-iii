...
@ManagedBean
@ViewScoped
public class DescargarOficioVTBean implements Serializable {

	private static final long serialVersionUID = -5248741953639127645L;

    private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(DescargarOficioVTBean.class);
    ...
    public void validarTareaBpm() {
        JsfUtil.validarPaginasUrlTareasBpm(bandejaTareasBean.getTarea(), "/prevencion/emisionviabilidadtecnica/descargarOficio.jsf");
    }
}
