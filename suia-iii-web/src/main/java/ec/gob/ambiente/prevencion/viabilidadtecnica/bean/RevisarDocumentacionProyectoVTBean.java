...
@ManagedBean
@ViewScoped
public class RevisarDocumentacionProyectoVTBean implements Serializable {

	private static final long serialVersionUID = -4920792922885277645L;

    private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(RevisarDocumentacionProyectoVTBean.class);
    ...
    public void validarTareaBpm() {
        JsfUtil.validarPaginasUrlTareasBpm(bandejaTareasBean.getTarea(), "/prevencion/emisionviabilidadtecnica/revisarDocumentacionProyecto.jsf");
    }
}
