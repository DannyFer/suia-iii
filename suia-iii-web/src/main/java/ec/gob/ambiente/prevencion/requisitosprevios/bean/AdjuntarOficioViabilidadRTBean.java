...
@ManagedBean(name = "adjuntarOficioViabilidadRTBean")
@ViewScoped
public class AdjuntarOficioViabilidadRTBean implements Serializable {

    private static final long serialVersionUID = 2975076547923496247L;

    private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger
            .getLogger(AdjuntarOficioViabilidadRTBean.class);
    ...
    public void validarTareaBpm() {
        JsfUtil.validarPaginasUrlTareasBpm(bandejaTareasBean.getTarea(), "/prevencion/licenciamiento-ambiental/adjuntarOficioViabilidad.jsf");
    }
}
