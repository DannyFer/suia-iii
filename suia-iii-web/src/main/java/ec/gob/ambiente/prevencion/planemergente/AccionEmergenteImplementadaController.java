...
@ManagedBean
@ViewScoped
public class AccionEmergenteImplementadaController {
   ...
   /* @Getter
    ...
    public void init() {
        ...
        acciones = accionEmergenteService.buscarPorEventos(eventosOcurridos, AccionEmergente.YA_IMPLEMENTADA);
    ...
    public void mostrar(int pos) {
        ...
        RequestContext.getCurrentInstance().execute("PF('accionEmergenteImplementadaDialog').show();");
    }

    public void editar(ActionEvent event) {
        if(validar(accionEmergente))
            RequestContext.getCurrentInstance().execute("PF('accionEmergenteImplementadaDialog').hide();");
    }
    ...
    public void guardar(ActionEvent event) {
        ...
        if(flat) {
            ...
            planEmergenteController.addSeccionCompletada(PlanEmergenteController.IMPLEMENTADAS);
    ...
    public void mostrarMedida(int pos) {
        ...
        RequestContext.getCurrentInstance().execute("PF('accionEmergenteImplementadaMedidaDialog').show();");
    }

    public void editarMedida(ActionEvent event) {
        RequestContext.getCurrentInstance().execute("PF('accionEmergenteImplementadaMedidaDialog').hide();");
    }
    ...
    public void mostrarIndicador(int pos) {
        ...
        RequestContext.getCurrentInstance().execute("PF('accionEmergenteImplementadaIndicadorDialog').show();");
    }

    public void editarIndicador(ActionEvent event) {
        RequestContext.getCurrentInstance().execute("PF('accionEmergenteImplementadaIndicadorDialog').hide();");
    }
