...
@ManagedBean
@ViewScoped
public class CriterioTecnicoVTBean implements Serializable {

	private static final long serialVersionUID = -4920799587639127645L;

    private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(CriterioTecnicoVTBean.class);
    ...
    public void init(){
        ...
        tipo = webParams.get("tipo"); //True, false -> revision
    ...
    public void validarTareaBpm() {
        JsfUtil.validarPaginasUrlTareasBpm(bandejaTareasBean.getTarea(), "/prevencion/emisionviabilidadtecnica/criterioTecnico.jsf?tipo=" + tipo);
    }
