...
@ManagedBean
@ViewScoped
public class AdjuntarOficioRequisitosTecnicosBean implements Serializable {

    private static final long serialVersionUID = 2975076514723496247L;

    private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger
            .getLogger(AdjuntarOficioRequisitosTecnicosBean.class);
    ...
    public void validarTareaBpm() {
        JsfUtil.validarPaginasUrlTareasBpm(bandejaTareasBean.getTarea(), "/prevencion/requisitosprevios/adjuntarOficioRequisitosTecnicos.jsf");
    }
}
