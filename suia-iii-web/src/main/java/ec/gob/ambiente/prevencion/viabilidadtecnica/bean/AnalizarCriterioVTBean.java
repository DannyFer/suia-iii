...
@ManagedBean
@ViewScoped
public class AnalizarCriterioVTBean implements Serializable {

	private static final long serialVersionUID = -985232953639127645L;

    private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(AnalizarCriterioVTBean.class);
    ...
    public void init(){
        try {
            ...
            criterioTecnico = "Criterio tecnico";
        } catch (Exception e) {
    ...
    public void validarTareaBpm() {
        JsfUtil.validarPaginasUrlTareasBpm(bandejaTareasBean.getTarea(), "/prevencion/emisionviabilidadtecnica/analizarCriterio.jsf");
    }
}
