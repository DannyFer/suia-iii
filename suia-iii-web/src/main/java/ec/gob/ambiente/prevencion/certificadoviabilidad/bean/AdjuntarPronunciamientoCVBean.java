...
@ManagedBean
@ViewScoped
public class AdjuntarPronunciamientoCVBean implements Serializable {

	private static final long serialVersionUID = -4920792922839127645L;

    private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(AdjuntarPronunciamientoCVBean.class);
