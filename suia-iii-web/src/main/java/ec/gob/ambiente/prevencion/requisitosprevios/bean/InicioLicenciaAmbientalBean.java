...
@ManagedBean
@ViewScoped
public class InicioLicenciaAmbientalBean implements Serializable {

    private static final long serialVersionUID = 2975076698424896247L;

    private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger
            .getLogger(InicioLicenciaAmbientalBean.class);
    ...
    public void validarTareaBpm() {
        JsfUtil.validarPaginasUrlTareasBpm(bandejaTareasBean.getTarea(), "/prevencion/requisitosprevios/inicioLicenciamientoAmbiental.jsf");
    }
}
