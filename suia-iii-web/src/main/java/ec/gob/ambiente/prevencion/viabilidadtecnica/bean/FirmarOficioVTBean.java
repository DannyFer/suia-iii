...
@ManagedBean
@ViewScoped
public class FirmarOficioVTBean implements Serializable {

	private static final long serialVersionUID = -652732953639127645L;

    private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(FirmarOficioVTBean.class);
    ...
    public void validarTareaBpm() {
        JsfUtil.validarPaginasUrlTareasBpm(bandejaTareasBean.getTarea(), "/prevencion/emisionviabilidadtecnica/firmarOficio.jsf");
    }
}
