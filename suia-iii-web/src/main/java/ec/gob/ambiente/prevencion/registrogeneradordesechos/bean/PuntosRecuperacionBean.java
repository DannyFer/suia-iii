...
@ManagedBean
@ViewScoped
public class PuntosRecuperacionBean extends RegistroGeneradorBaseBean {
    ...
    public void aceptar() {
        if (tipoDocumentoCertificadoCompatibilidad)
            puntoRecuperacion.setCertificadoCompatibilidadUsoSuelos(null);
        else
            puntoRecuperacion.setCertificadoUsoSuelos(null);
  
        puntoRecuperacion.setUbicacionesGeografica(JsfUtil.getBean(AdicionarUbicacionesBean.class).getUbicacionesSeleccionadas().get(0));
        puntoRecuperacion.setFormasPuntoRecuperacion(getFormasPuntoRecuperacion());
    ...
    private List<FormaPuntoRecuperacion> getFormasPuntoRecuperacion() {
        List<FormaPuntoRecuperacion> result = new ArrayList<FormaPuntoRecuperacion>();
