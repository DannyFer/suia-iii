...
@ManagedBean(name = "ecosistemaAcuatico")
@ViewScoped
public class EcosistemasAcuaticosBean implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 532704383250882792L;
	...
	public void init() {
		...
		try {
			...
			setCoordenadas(caracterizacionReferencialFacade.obtenerCoordenadas(
					eia.getId(),
					CoordenadaGeneral.PREFIX_EIA_ACUATICO
	...
	public void agregarCoordenada() {
		...
		coordenada.setNombreTabla(CoordenadaGeneral.PREFIX_EIA_ACUATICO
				+ EstudioImpactoAmbiental.class.getSimpleName());
