...
@ManagedBean(name="cualitativoBean")
public class FloraCualitativoBean {
	...
	public FloraCualitativoBean(Integer id, String puntoMuestreo, int contador,
			Double px1, Double px2, Double px3, Double px4, Double py1,
			Double py2, Double py3, Double py4, Double altitud1,
