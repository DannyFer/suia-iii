...
public class LazyEnvioNotificationesMailDataModel extends LazyDataModel<EnvioNotificacionesMail> {
    ...
    public List<EnvioNotificacionesMail> load(int first, int pageSize, String sortField,
        ...
        Integer listado_interno = 0;
   		listado_interno = envioNotificacionesMailFacade.contarRegistros(JsfUtil.getLoggedUser(), false);
    	Integer total = listado_interno;
    	listaNotificaciones = envioNotificacionesMailFacade.buscarNotificacionesEnviadas(first, pageSize,JsfUtil.getLoggedUser(),codigo, false);
    	this.setRowCount(total);
        return listaNotificaciones;
    }
    
	public LazyEnvioNotificationesMailDataModel(String nombreUsuario) {
