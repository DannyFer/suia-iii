...
@Stateless
public class ReporteGADProvincial {
	...
	public String visualizarOficio(String codigoProyecto, String resolucion, String oficio, String licencia) {
		...
		try {
			...
			if (org == null) {
				...
				cedula = this.proyectoLicenciamientoAmbiental.getUsuario().getPin().toString();
				contacto = contactoFacade.buscarPorPersona(proyectoLicenciamientoAmbiental.getUsuario().getPersona());
			} else {
...
//			entityInforme.setParametroFecha(""+fecha.format(new java.util.Date()));
			entityInforme.setParametroFecha(" 11 de Junio de 2020");
