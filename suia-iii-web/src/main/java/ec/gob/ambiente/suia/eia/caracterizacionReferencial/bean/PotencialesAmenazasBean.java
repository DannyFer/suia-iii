...
@ManagedBean(name = "potencialesAmenazas")
@ViewScoped
public class PotencialesAmenazasBean implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -1009741791495461161L;
	...
	public void init() {
		...
		try {
			...
			setCoordenadas(caracterizacionReferencialFacade.obtenerCoordenadas(
					getEiaId(),
					CoordenadaGeneral.PREFIX_EIA_AMENAZAS
	...
	public void agregarCoordenada() {
		...
		coordenada.setNombreTabla(CoordenadaGeneral.PREFIX_EIA_AMENAZAS
				+ EstudioImpactoAmbiental.class.getSimpleName());
