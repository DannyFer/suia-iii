package revisarInformeSistematizacion;
...
@ManagedBean
@ViewScoped
public class RevisarInformeSistematizacionController {
	...
	public void completarTarea(){
		try {
			...
			{
				params.put("accionesComplementarias", requiereAccionesComplementarias);
			}
