...
@ManagedBean
@ViewScoped
public class PlanManejoAmbientalOperacionCoaController {
	private final Logger LOG = Logger.getLogger(PlanManejoAmbientalOperacionCoaController.class);
	...
	@Getter
	@Setter
	private String codigoRGD, sub_plan_cierre_abandono;
	...
	public void init(){
	    ...
	    if(esActividadRelleno){
	    	if(faseRegistroAmbientalController.validateDataViabilidad()){
	    		faseViabilidadTecnica = faseRegistroAmbientalController.obtenerFaseOperacion();
	    		if(pmaViabilidad)
	    ...
	    if(!esActividadRelleno){
	    	if(listaPlanPma != null){
		    	for (EntidadPma entidadPlanInicial : listaPlanPma){
		    		if(entidadPlanInicial.getPlanId().equals(12)){
	...
	public void cargarPmaPoractividades(){
		...
		// cargo el plan de la activida principal
	...
	public void cargarPmaPorActividadesViabilidad(){
		try {
			...
			for(EntidadPmaViabilidad entidadPlanInicial : listaPlanPmaVia){
				...
				listaPlanAspectoViabilidad = new ArrayList<AspectoViabilidadTecnica>();
				listaPlanAspectoViabilidad = aspectoViabilidadTecnicaFacade.obtenerAspectoAmbientalPorPlan(entidadPlanInicial.getPlanId());
				entidadPlanInicial.setListaAspectoAmbiental(listaPlanAspectoViabilidad);
				
				//planes ingresados por el susuairo
	...
	public void mostrarAdicionarPlanViabilidadAdicional(EntidadPmaViabilidad objetoEntidad){
		...
		listaPlanAspectoViabilidad = objetoEntidad.getListaAspectoAmbiental();
	}
	...
	public void editarPlanPMAViabilidadNuevo(PmaViabilidadTecnica pma, List<AspectoViabilidadTecnica> listaAspectoAmbiental){
		planPmaViaNuevo = pma;
		listaPlanAspectoViabilidad = listaAspectoAmbiental;
	}
