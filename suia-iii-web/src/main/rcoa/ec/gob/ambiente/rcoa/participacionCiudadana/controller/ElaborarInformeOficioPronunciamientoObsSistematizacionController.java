...
@ManagedBean
@ViewScoped
public class ElaborarInformeOficioPronunciamientoObsSistematizacionController {
	...
	@Getter
    @Setter
    private Boolean observacionesOperador;
	...
	public void completarTarea(){
		try {
			...
			//Coordinador Area
			//Zonal -> responsable oficina tecnica
			//GAD -> tecnico reasignacion coordinador provincial
			//PC -> coordinado electrico , minero, otros sectores, hidrocarburos.
			params.put("coordinadorArea", "1717679441");
			params.put("observacionesOperador", observacionesOperador);
