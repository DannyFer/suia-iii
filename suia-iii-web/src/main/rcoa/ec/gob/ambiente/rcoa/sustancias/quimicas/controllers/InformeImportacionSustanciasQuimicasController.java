...
@ManagedBean
@ViewScoped
public class InformeImportacionSustanciasQuimicasController implements Serializable {

	private static final long serialVersionUID = 165683211928358047L;

	private final Logger LOG = Logger.getLogger(InformeImportacionSustanciasQuimicasController.class);
