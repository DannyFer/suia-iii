 ...
 *
 */
public class OficioAprobadoPAHtml {
	...
	public OficioAprobadoPAHtml(){}
	
	public OficioAprobadoPAHtml(OficioPronunciamientoEsIA oficio,
	...
	public String getAntecedentesOficio(){
		return oficio.getAntecedentes();
	}
	
	public String getConclusionesOficio(){
		return oficio.getConclusiones();
	}
