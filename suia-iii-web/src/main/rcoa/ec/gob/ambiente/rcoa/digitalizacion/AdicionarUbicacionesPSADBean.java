...
@ManagedBean
@ViewScoped
public class AdicionarUbicacionesPSADBean implements Serializable{
	...
	public void agregarUbicacion() {
		...
		if (provincia == null) {
			JsfUtil.addMessageErrorForComponent("provincia_panelUbicacion", JsfUtil.getMessageFromBundle(null,
		...
		if (!getUbicacionesSeleccionadas().contains(ubicacionesGeografica)) {
