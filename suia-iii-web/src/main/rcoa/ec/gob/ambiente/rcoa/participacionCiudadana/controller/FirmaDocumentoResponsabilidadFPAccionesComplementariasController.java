...
@ManagedBean
@ViewScoped
public class FirmaDocumentoResponsabilidadFPAccionesComplementariasController {
	...
	public void completarTarea(){
		try {
			...
			//PC - tecnico responsable de ppc.
			//GAD - tecnico responsable de ppc.
			//ZONAL - tecnico de calidad.
			params.put("tecnicoResponsablePPC", "1717679441");
