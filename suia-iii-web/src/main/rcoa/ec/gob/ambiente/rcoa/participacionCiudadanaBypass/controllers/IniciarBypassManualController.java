...
import ec.gob.ambiente.rcoa.participacionCiudadana.facade.PPCBypassFacade;
...
@ManagedBean
@ViewScoped
public class IniciarBypassManualController implements Serializable{
	...
	@EJB
    private PPCBypassFacade pPCBypassFacade;
	...
	public void iniciarBypass() {
		...
		if(pPCBypassFacade.verificarProcesoIniciado(proyecto.getCodigoUnicoAmbiental())) {
	...
	public void iniciarAutomatico() {
		List<String> listaProyectos = pPCBypassFacade.getProyectosEiaAprobados();
